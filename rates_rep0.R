...
####################################################################################################################
spread3_all <- read_tsv("C:/Users/gev25289/Desktop/december clusters/rep0/spread3.txt") 
...
logfile <- read_delim("C:/Users/gev25289/Desktop/december clusters/rep0/rep0.combined.location.rates.log")
...
#ggsave("C:/Users/gev25289/Desktop/december clusters/rep0/color_rates_grid.pdf", combined_plot_colors, width = 23, height = 7, units = "cm")
all_plot_colors
#ggsave("C:/Users/gev25289/Desktop/december clusters/rep0/color_rates.pdf", all_plot_colors, width = 22, height = 7, units = "cm")
...
combined_plot_thick
ggsave("C:/Users/gev25289/Desktop/december clusters/rep0/thickness_rates_grid.pdf", combined_plot_thick, width = 23, height = 7, units = "cm")

all_plot_thick
ggsave("C:/Users/gev25289/Desktop/december clusters/rep0/thickness_rates.pdf", all_plot_thick, width = 23, height = 7, units = "cm")

# To combine with other subsamples later
# Create a title grob
title_grob <- ggdraw() + 
  draw_label("Replicate 0", size = 10, fontface = "bold", hjust = 0.5, vjust = 2)

# Combine the title and the final plot
rep0_combined_plot_thick <- plot_grid(
...
rep0_combined_plot_thick

rep0_all_plot_thick <- plot_grid(
  title_grob,          # Add the title grob
  all_plot_thick,  # Your combined plot with legend
  ncol = 1,
  rel_heights = c(0.1, 0.9),  # Space for title and plot
  labels = NULL          # No need for additional labels
)
...
bf_combined_plot <- plot_grid(#substantial_plot, 
                              ...
                              ncol = 1)
ggsave("C:/Users/gev25289/Desktop/december clusters/rep0/bf_grid.pdf", bf_combined_plot, width = 3, height = 8, units = "cm")

#To combine with other subsamples later
# Create a title grob
title_grob <- ggdraw() + 
  draw_label("Replicate 0", size = 8, fontface = "bold", hjust = 0.5)

# Combine the title and the plot using plot_grid
rep0_bf_combined_plot <- plot_grid(
  title_grob,           # Add the title grob
